"""Vendored court-keypoint network (heatmap CNN).

Source: https://github.com/yastrebksv/TennisCourtDetector — a TrackNet-style
encoder/decoder that takes ONE 640x360 image and outputs 15 heatmaps (14 court
keypoints + 1 court-centre used only for training convergence). Kept byte-for-byte
compatible with the published checkpoint.
"""
