...
One lead session dispatches five specialist subagents -- pm, researcher, backend-dev,
...
may call any other. The roles are built around anti-goals as much as goals: researcher never
